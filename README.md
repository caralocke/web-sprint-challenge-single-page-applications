...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    A) useRouteMatch will try to match the current URL in the same way that a rendering Route would. 
1. How would you explain form validation to someone who has never programmed before?
    A) It's another component you create to help verify the user is putting in the correct information you're requiring. (I would add 'have you ever seen where it tells you a password must contain certain criteria? Yeah it makes that happen.')
1. In 1-2 sentences, define end to end testing.
    A) End to end testing is when you test an entire application from beginning to end.
